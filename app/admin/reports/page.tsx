...
export default function ReportsPage() {
  ...
  const getContentLink = (report: Report) => {
    if (report.type === "project" && report.project) {
      ...
      return `/forum/${report.comment.topicId}`
    }
    return "#"
  }
          ...
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Reported on {formattedDate} by {report.reporter?.firstName || "Unknown"}{" "}
      ...
      <Tabs defaultValue="pending">
        ...
        <TabsContent value="resolved" className="mt-4">
          {resolvedReports.length > 0 ? (
            ...
            <p className="text-center text-muted-foreground py-8">No resolved reports</p>
          )}
        </TabsContent>
